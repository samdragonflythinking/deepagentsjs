...
**Session ID**: 2025-11-12T11-18-48-run-swot-analysis-on-tesla-for
...
```
Error in middleware "FilesystemMiddleware": Error invoking tool 'write_file' with kwargs {"file_path":"/outputs/swot-tesla-investment-thesis-2025-11-12.md"} with error: Error: Received tool input did not match expected schema
