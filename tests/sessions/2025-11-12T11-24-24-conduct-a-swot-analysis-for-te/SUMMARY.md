...
**Session ID**: 2025-11-12T11-24-24-conduct-a-swot-analysis-for-te
...
```
Error in middleware "FilesystemMiddleware": Error invoking tool 'write_file' with kwargs {"file_path":"/outputs/swot-tesla-investment-3-5yr-2025-01-12.md"} with error: Error: Received tool input did not match expected schema
